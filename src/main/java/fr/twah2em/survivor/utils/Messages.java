...
public abstract class Messages {
    public static final Component PREFIX = Component
            .text("[", GOLD)
            .append(text("§cSurvivor", RED))
            .append(text("]", GOLD))
            .append(text(" ", WHITE));

    public static final Component RESTART_MESSAGE = PREFIX.append(text("Le serveur redémarre !", RED));

    public static final Component ROUND_START_MESSAGE = PREFIX.append(text("Le round %round% commence !", GREEN, BOLD));

    public static final Component ROUND_END_MESSAGE = PREFIX.append(text("Le round %round% est terminé ! 30 secondes de pause !", GREEN, BOLD));

    public static final Component ZOMBIE_KILLED_MESSAGE = PREFIX.append(text("+90$", DARK_GREEN, ITALIC));
    ...
    public static final Component CANNOT_CREATE_ROOM = PREFIX.append(text("Vous ne pouvez pas créer une pièce tant qu'un joueur est en train d'en créer " +
            "une ! Si vous voulez tout de même le faire, vous pouvez kick le joueur %player% qui est en train d'en créer une.", RED));
    ...
    public static final Component CUBOID_1_SUCCESSFULLY_CREATED = PREFIX
            .append(text("Vous avez bien défini la location %location% comme le point", GREEN))
            .append(text(" n°1 ", GOLD))
            .append(text("du cuboid", GREEN));

    public static final Component CUBOID_2_SUCCESSFULLY_CREATED = PREFIX
            .append(text("Vous avez bien défini la location %location% comme le point", GREEN))
